...
class TestUserEdit:
    ...
    def test_edit_name_email_password_with_auth(self, user_login, registration_data_generator):
    ...
    def test_edit_name_email_password_without_auth(self, registration_data_generator):
        payload = copy.copy(registration_data_generator)
